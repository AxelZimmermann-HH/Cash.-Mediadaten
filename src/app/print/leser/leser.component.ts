...
export class LeserComponent {
  ...
  kpis2 = [
    {
      icon: 'assets/img/siegel-print8.png',
      ivw: '',
      titleKey: 'PRINT.LESER.L2',
      subtitleKey: '',
      studies: 'PRINT.LESER.L12A',
    ...
    {
      icon: 'assets/img/siegel-print6.png',
      ivw: '',
      titleKey: 'PRINT.LESER.L2',
      subtitleKey: '',
      studies: 'PRINT.LESER.L12',
      infos: 'PRINT.LESER.L3B',
      infos2: '',
      infos3: '',
      infos4: '',
    },
    {
      icon: 'assets/img/siegel-print7.png',
      ivw: '',
      titleKey: 'PRINT.LESER.L2',
      subtitleKey: '',
      studies: 'PRINT.LESER.L12',
      infos: 'PRINT.LESER.L3C',
      infos2: '',
      infos3: '',
      infos4: '',
    },
