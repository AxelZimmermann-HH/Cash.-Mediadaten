...
@Component({
  selector: 'app-nl2-infos',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './nl2-infos.component.html',
  styleUrl: './nl2-infos.component.scss'
})
export class Nl2InfosComponent {

  data = [
    { label: 'ONLINE.USER.ICON2', value: 82, color: '#b70d20' },
    { label: 'ONLINE.USER.ICON1', value: 73, color: '#b70d20' },
    { label: 'ONLINE.USER.ICON3', value: 55, color: '#b70d20' },
    { label: 'ONLINE.USER.ICON4', value: 41, color: '#b70d20' }
  ];
